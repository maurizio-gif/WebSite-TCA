...
corpo_en: |-
  ...
  Below are all the details on tryout dates, course start dates, and membership requirements.

  TRYOUT DATES:
  Pre-registered by August 15: September 1–4, 2026 (3:00 PM to 6:30 PM).

  Non-pre-registered (Open to all): September 7–18, 2026, Monday through Friday (3:00 PM to 6:30 PM).

  COURSES BEGIN:
  Monday, September 21, 2026.

  Mandatory Membership: To participate in the courses, you must hold a valid FITP membership (Competitive or Non-Competitive) and present a valid medical certificate.
---
