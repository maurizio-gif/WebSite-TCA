...
const pagine = defineCollection({
  ...
  schema: z.object({
    ...
    camps_info_rapide: z.array(z.object({
      label: z.string(),
      valore: z.string(),
      label_en: z.string().optional(),
      valore_en: z.string().optional(),
    })).optional(),
    camps_giornata_eyebrow: z.string().optional(),
    camps_giornata_titolo: z.string().optional(),
    camps_giornata: z.array(z.object({
      orario: z.string(),
      titolo: z.string(),
      testo: z.string(),
      titolo_en: z.string().optional(),
    ...
    camps_settimanale_eyebrow: z.string().optional(),
    camps_settimanale_titolo: z.string().optional(),
    camps_settimanale: z.array(z.object({
      giorno: z.string(),
      colpo: z.string(),
      testo: z.string(),
      giorno_en: z.string().optional(),
      colpo_en: z.string().optional(),
      testo_en: z.string().optional(),
    })).optional(),
    camps_cosa_portare_titolo: z.string().optional(),
    camps_cosa_portare: z.array(z.string()).optional(),
    camps_obbligatorio: z.string().optional(),
    camps_kit_benvenuto: z.string().optional(),
    camps_quote_eyebrow: z.string().optional(),
    camps_quote_titolo: z.string().optional(),
    camps_quote_righe: z.array(z.object({
      categoria: z.string(),
      prezzo_settimana: z.string(),
      prezzo_dal2: z.string(),
      prezzo_fratelli: z.string(),
      categoria_en: z.string().optional(),
    })).optional(),
    camps_quote_note: z.array(z.string()).optional(),
    camps_cta_label: z.string().optional(),
    ...
    camps_giornata_eyebrow_en: z.string().optional(),
    camps_giornata_titolo_en: z.string().optional(),
    camps_settimanale_eyebrow_en: z.string().optional(),
    camps_settimanale_titolo_en: z.string().optional(),
    camps_cosa_portare_titolo_en: z.string().optional(),
    camps_cosa_portare_en: z.array(z.string()).optional(),
    camps_obbligatorio_en: z.string().optional(),
    camps_kit_benvenuto_en: z.string().optional(),
    camps_quote_eyebrow_en: z.string().optional(),
    camps_quote_titolo_en: z.string().optional(),
