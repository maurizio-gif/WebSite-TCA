      ...
      (() => {
        ...
        return {
          ...
          templates: [
            ...
            {
              name: 'scuola_tennis_estiva',
              label: 'Scuola Tennis Estiva (sezione su Summer Camps)',
              fields: [
                { type: 'string', name: 'scuolaestiva_eyebrow', label: 'Eyebrow', required: true },
                { type: 'string', name: 'scuolaestiva_titolo', label: 'Titolo', required: true },
                { type: 'string', name: 'scuolaestiva_titolo_accent', label: 'Titolo evidenziato', required: true },
                { type: 'string', name: 'scuolaestiva_testo', label: 'Testo introduttivo', required: true, ui: { component: 'textarea' } },
                {
                  type: 'object', name: 'scuolaestiva_info_rapide', label: 'Info rapide', list: true, required: true,
                  ui: { itemProps: (item) => ({ label: item?.label || 'Nuova info' }) },
                  fields: [
                ...
                {
                  type: 'object', name: 'scuolaestiva_quote_righe', label: 'Tabella quote', list: true, required: true,
                  ui: { itemProps: (item) => ({ label: item?.categoria || 'Nuova riga' }) },
                  fields: [
                ...
                { type: 'string', name: 'scuolaestiva_note', label: 'Note/condizioni', list: true, required: true, ui: { component: 'textarea' } },
                { type: 'string', name: 'scuolaestiva_cta_label', label: 'Etichetta bottone iscrizione', required: true },
                { type: 'string', name: 'scuolaestiva_eyebrow_en', label: '🇬🇧 Eyebrow (inglese)' },
                { type: 'string', name: 'scuolaestiva_titolo_en', label: '🇬🇧 Titolo (inglese)' },
                { type: 'string', name: 'scuolaestiva_titolo_accent_en', label: '🇬🇧 Titolo evidenziato (inglese)' },
                { type: 'string', name: 'scuolaestiva_testo_en', label: '🇬🇧 Testo introduttivo (inglese)', ui: { component: 'textarea' } },
                { type: 'string', name: 'scuolaestiva_note_en', label: '🇬🇧 Note/condizioni (inglese)', list: true, ui: { component: 'textarea' } },
                { type: 'string', name: 'scuolaestiva_cta_label_en', label: '🇬🇧 Etichetta bottone iscrizione (inglese)' },
              ],
            },
            {
              name: 'scuola_tennis',
